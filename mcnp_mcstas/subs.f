...
!      print *, 'x,y,z ',to_mcstas(1), to_mcstas(2), to_mcstas(3)

      speed=sqrt(2.* ssb(4)*Mev2Joule/MNEUTRON)
!      print *, 'EK speed energy in', ssb(4)
      ...
      to_mcstas(8) = ssb(5)          ! time

!      print *, 'EK speed neutron in', speed
!      print *, 'EK angles in', ssb(9), ssb(10), ssb(4), ssb(5)
!      print *, 'EK velocity in', to_mcstas(4), to_mcstas(5),to_mcstas(6) 
!      print *, 'EK pos in', to_mcstas(1), to_mcstas(2),to_mcstas(3) 
...
!      print *, 'EK speed neutron out', speed
      energy=0.5*MNEUTRON*(speed**2)/Mev2Joule
!      print *, 'EK speed energy out', energy
      ssb(4)=energy
      ssb(5)=from_mcstas(8)
...
!      print *, 'EK angles out', ssb(9), ssb(10), ssb(4), ssb(5)
!      print *, 'EK v out',from_mcstas(4), from_mcstas(5), from_mcstas(6)   
!      print *, 'EK out',from_mcstas(1), from_mcstas(2), from_mcstas(3)   
...
!      nrss=972626  !ok
!      nrss=972627  ! for meget.
! VIRKER      nrss=999693 !EK fra rssa header
!      nrss= 99969227      !EK fra rssa header
      nrss=133714156 !from EK from Virtual_mcnp_out - countero
